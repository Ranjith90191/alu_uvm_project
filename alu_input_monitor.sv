class alu_input_monitor extends uvm_monitor;
    ...
    virtual task watch_inputs();
        ...
        forever begin
            ...
            `uvm_info("MON", $sformatf("Inputs: mode=%0d, cmd=%0d, OA=%0h, OB=%0h, cin=%0d, inp_valid=%0b",pkt.mode, pkt.cmd, pkt.OA, pkt.OB, pkt.cin, pkt.inp_valid), UVM_LOW)
